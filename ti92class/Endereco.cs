...
namespace ti92class
{
    public class Endereco
    {
        ...
        {
            var cmd = Banco.Abrir();
            cmd.CommandText = "insert enderecos (cliente_id,cep, logradouro, numero, complemento, bairro, cidade, estado, uf, tipo) values" +
                "("+cliente_id+", '"+Cep+"', '"+Logradouro+"', '"+Numero+"', '"+Complemento+"', '"+Bairro+"', '"+Cidade+"', '"+Estado+"', '"+Uf+"', '"+Tipo+"')";
            cmd.ExecuteNonQuery();
